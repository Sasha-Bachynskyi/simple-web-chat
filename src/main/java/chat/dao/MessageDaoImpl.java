...
public class MessageDaoImpl implements MessageDao {
    ...
    public List<Message> getLastTenMessages() {
        String query = "SELECT u.name as user_name, m.id as message_id, m.content as content, u.id as user_id FROM messages m JOIN users u ON m.user_id = u.id ORDER BY m.id DESC LIMIT 10;";
